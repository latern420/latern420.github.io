...
Enemy.prototype = {
    setMovement: function(right, down) {
        if(right === 0 && right === down) 
            right = -1;     // временный говно костыль
...
gameStates.boot.prototype = {
    preload: function() {
        ...
        this.game.load.image('loadingBg', 'images/loadingBg.png');
    },
...
gameStates.loading.prototype = {
    preload: function() {
        this.game.load.image('grass', 'images/snowygrass.png');
        this.game.load.image('player', 'images/player.png');
        this.game.load.image('scorePicture', 'images/scorePicture.png');
        this.game.load.image('enemy1', 'images/enemy1.png');
        this.game.load.image('mamonHead', 'images/mamonHead.png');
...
gameStates.stage1.prototype = {
    create: function() {
        ...
        this.player = new Player(this.game.add.sprite(200, 350, 'mamonHead'));
        this.player._sprite.anchor.setTo(0.5, 0.5);
    ...
    update: function() {
        this.handleControls();
        this.player._sprite.rotation += 0.03;
        for(var index in this.enemies) {
            var enemy = this.enemies[index];
            enemy._sprite.position.x += enemy.getXMovement() / 1.2;
            enemy._sprite.position.y += enemy.getYMovement() / 1.2;
        }
    ...
    handleControls: function() {
        if (cursors.left.isDown)
            this.player._sprite.position.x -= 4;
        else if (cursors.right.isDown)
            this.player._sprite.position.x += 4;
        if (cursors.up.isDown)
            this.player._sprite.position.y -= 4;
        else if (cursors.down.isDown)
            this.player._sprite.position.y += 4;
    },

    spawnEnemy: function() {
        var willSpawn = (this.game.rnd.integerInRange(1, 100) <= this.chanceToSpawnEnemy);
        if(willSpawn) {
            var enemy = new Enemy(this.game.add.sprite(this.game.rnd.integerInRange(50, 1150), 
                this.game.rnd.integerInRange(50, 550), 'enemy1'));
            enemy.setMovement(this.game.rnd.integerInRange(-2, 2), this.game.rnd.integerInRange(-2, 2));
            this.enemies.push(enemy);
        }
    },

    createUI: function() {
        this.scoreText    = this.game.add.text(75, 540, "000", this.scoreTextStyle);
        this.scorePicture = this.game.add.sprite(15, 540, 'scorePicture');
        this.scoreText.setShadow(3, 3, 'rgba(157,0,255,0.9)', 15);
    },
    ...
    enemies: [],
    frame: 0,
    chanceToSpawnEnemy: 75,

    score: 0,
    scoreTextStyle: { font: "48px Arial", fill: "#ffffff", align: "center" },
    scoreText: 0,
    scorePicture: 0,
}
